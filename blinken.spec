...
Version  : 23.04.0
Release  : 51
URL      : https://download.kde.org/stable/release-service/23.04.0/src/blinken-23.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/blinken-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/blinken-23.04.0.tar.xz.sig
...
%prep
%setup -q -n blinken-23.04.0
cd %{_builddir}/blinken-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682024031
mkdir -p clr-build
pushd clr-build
