...
Version  : 21.08.3
Release  : 33
URL      : https://download.kde.org/stable/release-service/21.08.3/src/blinken-21.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/blinken-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/blinken-21.08.3.tar.xz.sig
...
%prep
%setup -q -n blinken-21.08.3
cd %{_builddir}/blinken-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636055631
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/blinken-21.08.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/blinken/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/blinken-21.08.3/LICENSES/GFDL-1.2-only.txt %{buildroot}/usr/share/package-licenses/blinken/7b300def279cc0c38b84d3351f68d558cc01ad61
cp %{_builddir}/blinken-21.08.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/blinken/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/blinken-21.08.3/LICENSES/LicenseRef-SJFonts.txt %{buildroot}/usr/share/package-licenses/blinken/0018a9a18b50c9dcea23b1178ba98063b5a9b018
cp %{_builddir}/blinken-21.08.3/LICENSES/LicenseRef-SJFonts.txt %{buildroot}/usr/share/package-licenses/blinken/0018a9a18b50c9dcea23b1178ba98063b5a9b018
cp %{_builddir}/blinken-21.08.3/fonts/steve.ttf.license %{buildroot}/usr/share/package-licenses/blinken/67bc81af1c395d6bd93b6687ff4eb1c15fe8a6f9
pushd clr-build
%make_install
popd
%find_lang blinken
