...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/blinken-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/blinken-24.05.2.tar.xz.sig
...
%setup -q -n blinken-24.05.2
cd %{_builddir}/blinken-24.05.2
pushd ..
cp -a blinken-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720577969
mkdir -p clr-build
pushd clr-build
